...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'api-explorer.com'
  config.app_name = 'Api_explorer'
  config.mailer.from = 'Api_explorer <no-reply@api-explorer.com>'
  ...
  #
  config.app_secret = 'bBLFNdi_b_bTmG53dJ6JVhnDg3Etmgb4q7wk2B5RzibQlVq9NKBCQf5BpbmqIpKxFyw'
